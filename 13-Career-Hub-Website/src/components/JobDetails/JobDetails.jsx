...
const JobDetails = () => {
    ...
    const { job_title, job_description, job_responsibility, educational_requirements, experiences, salary, job_type, contact_information } = job;
    return (
        <div className="mb-10">
            <div className="grid gap-4 md:grid-cols-4 mt-20">
                ...
                <div>
                    ...
                    <button className="btn btn-gradient w-full mt-6">Apply Now</button>
                </div>
